...
namespace PackageTracking {
  ...
  class PackageStatus {
    private:
      ...
      // including this one.
      std::list<ShippingUpdate> shipments;

      std::string tracking_number_; //This will be the tracking number
    ...
    public:
      ...
      void AddUpdate(const std::string& description, const std::string& location, std::time_t timestamp);
